    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    <h4 class="page-title">删除应用</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">应用管理</a></li>
                        <li class="breadcrumb-item active" aria-current="page">删除应用</li>
                    </ol>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header"><i class="fa fa-table"></i>删除应用</div>
                        <div class="card-body">
    ...
    mounted() {
        ...
        if (this.once) {
            ...
            table
                .buttons()
                .container()
                .appendTo("#example_wrapper5 .col-md-6:eq(0)");
            this.once = false;
            // 为所有按钮元素添加样式
