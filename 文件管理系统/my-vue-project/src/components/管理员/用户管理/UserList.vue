...
export default {
    ...
    methods: {
        ...
        fetchData() {
            try {
                const res = axios.get('http://192.168.0.104:8086/user/');
                if (res.status === 200) {
                    console.log('http://192.168.0.104:8086/user/');
        ...
        async initializeDataTable() {
            ...
            try {
                if (!$.fn.DataTable.isDataTable('#example9')) {
                    ...
                    try {
                        const promise = await axios.get('http://192.168.0.104:8086/user/');
                    ...
                    this.$nextTick(() => {
                        ...
                        $('#example9 tbody').on('click', '.edit-btn', (event) => {
                            ...
                            axios.get('http://192.168.0.104:8086/user/' + data).then(res => {
                        ...
                        $('#example9 tbody').off('click', '.delete-btn').on('click', '.delete-btn', (event) => {
                            axios.delete('http://192.168.0.104:8086/user/' + $(event.currentTarget).val()).then(res => {
                                if (res.data) {
                                    console.log('删除成功');
                                    alert('删除成功');
                                } else {
