...
export default {
    ...
    methods: {
        ...
        fetchData() {
            try {
                const res = axios.get('http://localhost:8086/department/');
                if (res.status === 200) {
                    console.log('http://localhost:8086/department/');
        ...
        async initializeDataTable() {
            ...
            try {
                if (!$.fn.DataTable.isDataTable('#example10')) {
                    ...
                    try {
                        const promise = await axios.get('http://localhost:8086/department/');
                    ...
                    this.$nextTick(() => {
                        ...
                        $('#example10 tbody').on('click', '.edit-btn', (event) => {
                            ...
                            axios.get('http://localhost:8086/department/' + data).then(res => {
                        ...
                        $('#example10 tbody').off('click', '.delete-btn').on('click', '.delete-btn', (event) => {
                            axios.delete('http://localhost:8086/department/' + $(event.currentTarget).val()).then(res => {
                                if (res.data) {
                                    console.log('删除成功');
                                    alert('删除成功');
                                } else {
