    ...
    methods: {
        ...
        submit() {
            ...
            if (this.file != null) {
                ...
                axios.post('http://127.0.0.1:8086/document/upload/file', formData)
                    .then(res => {
                        if (res.data) {
                            return axios.put('http://127.0.0.1:8086/document/' + this.user.id + '/' + this.document.id, this.document);
                        } else {
                ...
                axios.put('http://127.0.0.1:8086/document/' + this.user.id + '/' + this.document.id, this.document)
                    .then(res => {
                        if (res.data) {
                            alert('更新成功');
                        } else {
