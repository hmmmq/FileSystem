    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    <h4 class="page-title" v-show="!user?.type">我的文档下载记录</h4>
                    <h4 class="page-title" v-show="user?.type">用户文档下载记录</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">文档下载记录管理</li>
                        <li class="breadcrumb-item active" aria-current="page" v-show="!user?.type">我的文档下载记录</li>
                        <li class="breadcrumb-item active" aria-current="page" v-show="user?.type">用户文档下载记录</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header"><i class="fa fa-table"></i> 文档下载记录列表</div>

                        <div class="card-body">

                            <div class="table-responsive">
                                <table id="example-documentdownloadtime" class="table table-bordered">
...
export default {
    ...
    data() {
        return {
            user: null,
            documentdownloadtimelist: [], // 初始化为空数组
            update: false,
            initialdocumentdownloadtime: {
                id: '',
                name: '',
                category: '',
                keyword: '',
    ...
    methods: {
        ...
        async updatelist() {
            ...
            var url = '';
            if (this.user.type) {
                url = 'http://192.168.0.101:8086/documentdownloadtime/';
            }
            else {
                url = 'http://192.168.0.101:8086/documentdownloadtime/user/' + this.user.id;
            }
        ...
        async initializeDataTable(url) {
            ...
            var documentdownloadtimelist2d = null;
            try {
                if (!$.fn.DataTable.isDataTable('#example-documentdownloadtime')) {
                    ...
                    try {
                        ...
                        if (promise.status === 200) {
                            ...
                            documentdownloadtimelist2d = this.convertTo2DArray(promise.data);
                        } else {
                            console.log(promise);
                            return;
                        }
                    ...
                    this.$nextTick(() => {
                        console.log(" var table = $('#example-documentdownloadtime').DataTable({");
                        var table = $('#example-documentdownloadtime').DataTable({
                            ...
                            data: documentdownloadtimelist2d,
                            columns: [
                                { title: '序号' },
                                { title: '记录ID' },
                                { title: '文件ID' },
                        ...
                        console.log("table.buttons().container().appendTo(#example-documentdownloadtime_wrapper.col-md-6:eq(0));");
                        table
                            .buttons()
                            .container()
                            .appendTo("#example-documentdownloadtime_wrapper .col-md-6:eq(0)");
        ...
        async destoryDataTable() {
            ...
            this.$nextTick(() => {
                if ($.fn.DataTable.isDataTable('#example-documentdownloadtime')) {
                    ...
                    $('#example-documentdownloadtime').DataTable().destroy();
                }
            });
        }
